...
export function Sidebar() {
    ...
    return (
        <motion.div
            ...
            className="h-screen bg-surface border-r border-white/10 flex flex-col relative hidden md:flex transition-all duration-300"
        >
            {/* Header */}
            ...
            <div className="p-4 border-t border-white/5 bg-black/20">
                <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-full bg-gradient-to-br from-pink-500 to-orange-400 shrink-0" />
                    {!collapsed && (
                    ...
                    {!collapsed && (
                        <Button variant="ghost" size="icon" className="h-8 w-8 ml-auto text-muted-foreground hover:text-red-400">
